        ...
        <>
            <div className="container p-8 mb-20 ms-[15%]  w-[70%]">
                ...
                <ul className="mt-2 ms-5 text-md font-medium grid gap-2 list-disc">
                    ...
                    <h1 className="text-xl font-bold mt-8">3. Perkembangan Sejarah Klasifikasi</h1>
                    <p className="mt-2 ms-5 text-md font-medium">
                    Ahli filosof Yunani, Aristoteles (384-322 SM) mengelompokkan makhluk hidup ke dalam dua kelompok besar yaitu 
                    kelompok hewan (animalia) dan kelompok tumbuhan (plantae), namun keberadaan organisme mikroskopis belum dikenal pada saat itu.
                    ...
                    <ul >
                        <li className="mt-2 ms-5 text-md font-medium grid gap-2 list-disc">Sistem Dua kingdom Sistem yang dikembangkan oleh ilmuwan Swedia yaitu Carolus Linnaeus tahun 1735.
                            ...
                            <ul className="mt-2 ms-5 text-md font-medium grid gap-2 list-decimal">
                                ...
                                <li>
                                    Kingdom Plantae (Dunia Tumbuhan) Ciri–ciri: memiliki dinding sel, berklorofil, mampu berfotosintesis.
                                </li>
                            </ul>
                        </li>
                    </ul>
             ...
             <div className="btm-nav btm-nav-md bg-base-200 grid grid-cols-3">
                <button>
                <a href="/subbio13" className="flex justify-center items-center">< MdOutlineKeyboardReturn size={20} className="me-6"/>Back to the Material</a>
                </button>
